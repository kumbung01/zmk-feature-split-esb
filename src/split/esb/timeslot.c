...
#define TIMER_EXPIRY_US_EARLY                                                                      \
    (TIMESLOT_LENGTH_US - MPSL_TIMESLOT_EXTENSION_MARGIN_MIN_US - TIMESLOT_EXT_MARGIN_MARGIN)
#define TIMER_EXPIRY_REQ                                                                           \
    (TIMESLOT_LENGTH_US - MPSL_TIMESLOT_EXTENSION_MARGIN_MIN_US - TIMESLOT_REQ_EARLIEST_MARGIN)
...
enum mpsl_timeslot_call { REQ_OPEN_SESSION, REQ_MAKE_REQUEST, REQ_CLOSE_SESSION };
...
static inline void timer0_cc_update(uint32_t channel0, uint32_t channel1) {
    nrf_timer_cc_set(NRF_TIMER0, NRF_TIMER_CC_CHANNEL0,
                     nrf_timer_cc_get(NRF_TIMER0, NRF_TIMER_CC_CHANNEL0) + channel0);
    nrf_timer_cc_set(NRF_TIMER0, NRF_TIMER_CC_CHANNEL1,
                     nrf_timer_cc_get(NRF_TIMER0, NRF_TIMER_CC_CHANNEL1) + channel1);
}
...
bool is_in_timeslot() { return m_in_timeslot; }

static mpsl_timeslot_signal_return_param_t *
mpsl_timeslot_callback(mpsl_timeslot_session_id_t session_id, uint32_t signal_type) {
...
void zmk_split_esb_timeslot_close_session(void) { schedule_request(REQ_CLOSE_SESSION); }
...
K_THREAD_DEFINE(mpsl_nonpreemptible_thread_id, STACKSIZE, mpsl_nonpreemptible_thread, NULL, NULL,
                NULL, K_PRIO_COOP(MPSL_THREAD_PRIO), 0, 0);
